<?php
	...
	$link = mysqli_connect("127.0.0.1:8888", "root", "m1V@81rQweM4*A/x", "smarttech");

	if (mysqli_connect_errno()) {
		echo 'CAN NOT CONNECT WITH THE DATABASE :<br/>' . mysqli_connect_errno(); //ERROR represent connection failed
	} else {
		mysqli_query($link, "SET NAMES utf8");//set the interaction code as UTF-8
	}
