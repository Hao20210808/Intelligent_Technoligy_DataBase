...
<div class="login">
  ...
  <form method="POST" action="checkUser.php">
    ...
    <div>管理員名稱: <input type="text" name="user_name" placeholder="User ID" style="width:200px;"/></div><br>
    <div>管理員密碼: <input type="password" name="user_password" placeholder="User password" style="width:200px;"/></div><br>
